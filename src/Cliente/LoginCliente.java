...
import static Servidor.LoginServidor.ipServidor;
import static Servidor.LoginServidor.punto;
...
public class LoginCliente extends javax.swing.JFrame {
    ...
    //Inicializamos una variable estática de la IP
    ...
    public LoginCliente() {
        ...
        placeholders();
        txtip.setText("192.168.0.117");
    }

    //Place Holders para el campo de texto IP
    void placeholders(){
        Placeholders.TextPlace txtu = new TextPlace("Ingrese IP del Servidor", txtip);
    }
    ...
    private void initComponents() {
        ...
        Fondo.setMaximumSize(new java.awt.Dimension(1000, 600));
        ...
        Encabezado.setPreferredSize(new java.awt.Dimension(1000, 80));
